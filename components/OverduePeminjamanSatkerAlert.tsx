// components/OverduePeminjamanSatkerAlert.tsx
...
interface OverduePeminjamanSatkerAlertProps {
  onNotificationCreated?: () => void;
}

export function OverduePeminjamanSatkerAlert({ onNotificationCreated }: OverduePeminjamanSatkerAlertProps) {
    ...
    <Alert variant="destructive" className="mb-4 sm:mb-6 border-red-300 bg-red-50">
      ...
      <AlertDescription className="mt-2 space-y-2">
        <p className="text-xs sm:text-sm font-medium text-red-900">
          ⚠️ Anda memiliki paket peminjaman yang telah melewati batas waktu pengembalian. Segera ajukan pengembalian!
        </p>
        ...
        <div className="mt-3 pt-2 border-t border-red-200">
          <p className="text-[10px] sm:text-xs text-red-800 font-medium">
            💡 Tindakan: Segera ajukan pengembalian HT melalui menu Riwayat Peminjaman atau hubungi Super Admin.
          </p>
        </div>
      </AlertDescription>
    </Alert>
